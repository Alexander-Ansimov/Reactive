...
import static com.example.essential.Part1CreationTransformationTermination.*;
...
public class Part1CreationTransformationTerminationTest {
    ...
    public void emptyObservableTest() {
        emptyIfInputIsGreaterThenZero(-1)
                .test()
                .assertValue("-1")
                .assertCompleted()
                .awaitTerminalEvent();
    ...
    @Test
    public void neverObservableTest() {
        neverIfInputIsGreaterThenZero(-1)
                .test()
                .assertValue("-1")
                .assertCompleted()
                .awaitTerminalEvent();
